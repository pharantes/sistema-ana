/**
 * ContasAPagar Model - Tracks payable accounts from actions
 */
import mongoose from 'mongoose';

/**
 * ContasAPagar schema - Manages staff and cost payment records
 */
...
ContasAPagarSchema.index({ reportDate: -1 });
ContasAPagarSchema.index({ status: 1 });
ContasAPagarSchema.index({ colaboradorId: 1 });
